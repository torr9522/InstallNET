...
Usage: $reinstall_____ anolis      7|8|23
                       ...
                       dd          --img="https://my.microsoftpersonalcontent.com/personal/0c3343be07ebf508/_layouts/15/download.aspx?UniqueId=08923d78-229b-4822-bb70-0e8d9a9ed826&Translate=false&tempauth=v1e.eyJzaXRlaWQiOiIzZWQ4OGY5MS1hYTQ0LTQ3ZjItYTgwYi03ZjQwNGU2ZTA3OGYiLCJhdWQiOiIwMDAwMDAwMy0wMDAwLTBmZjEtY2UwMC0wMDAwMDAwMDAwMDAvbXkubWljcm9zb2Z0cGVyc29uYWxjb250ZW50LmNvbUA5MTg4MDQwZC02YzY3LTRjNWItYjExMi0zNmEzMDRiNjZkYWQiLCJleHAiOiIxNzc1MjMyOTc3In0.6oD9a_a11O98TqXp12O7_q6fRLKF0UztDWPSE-TTgthFAmVzordoUoaQcQjEcPT-8JDDgYYGeLOkBenZJ0WvKbxfJvrYLVB8Jz33SJTIGktfBm0k-9x06rS3Wedj_o7QAzDkjBiY2WvrtWY_NI&ApiVersion=2.0" (raw image stores in raw/vhd/tar/gz/xz/zst)
                       windows     --image-name="windows xxx yyy" --lang=xx-yy
                       windows     --image-name="windows xxx yyy" --iso="https://my.microsoftpersonalcontent.com/personal/0c3343be07ebf508/_layouts/15/download.aspx?UniqueId=08923d78-229b-4822-bb70-0e8d9a9ed826&Translate=false&tempauth=v1e.eyJzaXRlaWQiOiIzZWQ4OGY5MS1hYTQ0LTQ3ZjItYTgwYi03ZjQwNGU2ZTA3OGYiLCJhdWQiOiIwMDAwMDAwMy0wMDAwLTBmZjEtY2UwMC0wMDAwMDAwMDAwMDAvbXkubWljcm9zb2Z0cGVyc29uYWxjb250ZW50LmNvbUA5MTg4MDQwZC02YzY3LTRjNWItYjExMi0zNmEzMDRiNjZkYWQiLCJleHAiOiIxNzc1MjMyOTc3In0.6oD9a_a11O98TQxp12O7_q6fRLKF0UztDWPSE-TTgthFAmVzordoUoaQcJjEcPT-8JDDgYYGeLOkBenZJ0WvKbxfJvrYLVB8Jz33SJTIGktfBm0k-9x06rS3Wedj_o7QAzDkjBiY2WvrtWY_NI&ApiVersion=2.0"
                       netboot.xyz
                       reset
...
get_windows_iso_link() {
    # If ISO URL is already provided via --iso, skip fetching
    [ -n "$iso" ] && return
    get_label_msdn() {
        if [ -n "$server" ]; then
            case "$version" in
...
iso="https://dlink.host/1drv/aHR0cHM6Ly8xZHJ2Lm1zL3UvYy8wYzMzNDNiZTA3ZWJmNTA4L0lRQjRQWklJbXlJaVNMdHdEbzJhbnRnbUFiQzJLdkJzUThFZjlUVER4aEx4dXFJ.iso"
                fi
            fi
